...
def preprocess_data(input_file, input_file_lbs, output_file, n_components=50):
    """
    ...
    # 展示一组数据以确认读取正确
    # 转换为 DataFrame
    digits_df = pd.DataFrame(digits_vec)
    # 设置 Pandas 显示选项
...
# 示例调用
preprocess_data('digits4000_digits_vec.txt','digits4000_digits_labels.txt', 'preprocessed_data.pkl')
